...
def get_language_detection_results(api_client, texts):
    results = []
    for text in texts:
        params = {"input_text": text, "model_name": api_client.model_name}
        response = requests.post(
...
def get_sentiment_detection_results(api_client, texts):
    results = []
    for text in texts:
        params = {"input_text": text, "model_name": api_client.model_name}
        response = requests.post(
...
def get_text_classification_results(api_client, texts):
    results = []
    for text in texts:
        params = {"input_text": text, "model_name": api_client.model_name}
        response = requests.post(
...
def get_entity_extraction_results(api_client, texts):
    results = []
    for text in texts:
        params = {"input_text": text, "model_name": api_client.model_name}
        response = requests.post(
...
def get_category_extraction_results(api_client, texts):
    results = []
    for text in texts:
        params = {"input_text": text, "model_name": api_client.model_name}
        response = requests.post(
